...
public class UserController {
	...
	public ResponseEntity<CreateUserResponseModel> searchByEmail(@PathVariable String email) {
	...
	@GetMapping("/findl/{lname}")
	public ResponseEntity<CreateUserResponseModel> searchByLastName(@PathVariable String lname) {
